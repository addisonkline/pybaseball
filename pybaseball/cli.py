...
def main() -> None:
    ...
    draft_parser.add_argument("--team", type=str, help="the team to get draft results for")
    draft_parser.add_argument("--keep-stats", action="store_true", help="keep stats in the results")
    ...
    if args.command == "draft":
        try:
            results = amateur_draft_data(args.year, args.round, args.team, args.keep_stats)
            print(results)
            sys.exit(0)
